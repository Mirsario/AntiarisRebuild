...
namespace Antiaris.Buffs.Minions
{
	public class ForestGuardianJunior : ModBuff
	{
		public override void SetDefaults()
		{
			...
			Description.AddTranslation((int)GameCulture.CultureName.Russian, "Младший страж леса сражается за вас");
		...
		public override void Update(Player player, ref int buffIndex)
		{
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<ForestGuardianJunior>()] > 0)
			{
