...
namespace Antiaris.Buffs.Minions
{
	public class ParrotJunior : ModBuff
	{
		public override void SetDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Маленький попугай");
			Description.AddTranslation((int)GameCulture.CultureName.Russian, "Маленький попугай сражается за вас");
