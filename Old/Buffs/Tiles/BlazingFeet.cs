...
namespace Antiaris.Buffs.Tiles
{
	public class BlazingFeet : ModBuff
	{
		public override void SetDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "燃烧之足");
			Description.AddTranslation((int)GameCulture.CultureName.Chinese, "增加移动速度");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Искрящиеся ноги");
			Description.AddTranslation((int)GameCulture.CultureName.Russian, "Увеличивает скорость передвижения");
