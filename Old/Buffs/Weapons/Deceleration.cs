...
namespace Antiaris.Buffs.Weapons
{
	public class Deceleration : ModBuff
	{
		public override void SetDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "减速");
			Description.AddTranslation((int)GameCulture.CultureName.Chinese, "水的力量干涉了你的移动速度");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Замедление");
			Description.AddTranslation((int)GameCulture.CultureName.Russian, "Сила Аквы повредила Ваши способности передвижения и уменьшила скорость перемещения");
