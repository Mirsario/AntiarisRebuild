...
namespace Antiaris.NPCs.Friendly
{
	public class CreeperEgg : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "爬行者之卵");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Яйцо паука");
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (npc.life <= 0)
			{
				...
				NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<BabyCreeperGround>(), 0, npc.whoAmI, npc.Center.X, npc.Center.Y, 0.0f, byte.MaxValue);
			}
		}
