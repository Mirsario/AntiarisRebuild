...
namespace Antiaris.NPCs.Enemies
{
	public class WilloWisp : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			bannerItem = ModContent.ItemType<WilloWispBanner>();
			banner = npc.type;
		}
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Блуждающий огонёк");
		...
		public override void AI()
		{
			...
			if (spawnTimer == 180 && !hasFlames)
			{
				...
				Projectile.NewProjectile(npc.Center.X + 10, npc.Center.Y + 60, 0, 0, ModContent.ProjectileType<WispFlame>(), 60, 5.0f, 0, 1f, npc.whoAmI);
				Projectile.NewProjectile(npc.Center.X + 10, npc.Center.Y - 40, 0, 0, ModContent.ProjectileType<WispFlame>(), 60, 5.0f, 0, 2f, npc.whoAmI);
				Projectile.NewProjectile(npc.Center.X + 60, npc.Center.Y, 0, 0, ModContent.ProjectileType<WispFlame>(), 60, 5.0f, 0, 3f, npc.whoAmI);
				Projectile.NewProjectile(npc.Center.X - 40, npc.Center.Y, 0, 0, ModContent.ProjectileType<WispFlame>(), 60, 5.0f, 0, 4f, npc.whoAmI);
		...
		public override void NPCLoot()
		{
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				{
					Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<WispLamp>(), 1, false, 0, false, false);
				}
