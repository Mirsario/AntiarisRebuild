...
namespace Antiaris.NPCs.Town
{
	public class BoundPirate : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "被捆绑的船长");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Связанный пират");
		...
		public void WakeUp()
		{
			...
			npc.Transform(ModContent.NPCType<Pirate>());
		}
