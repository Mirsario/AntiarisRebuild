...
namespace Antiaris.NPCs.Town
{
	public class ConfusedGuide : ModNPC
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Сбитый с толку Гид");
		}
		...
		protected void guideQuest()
		{
			...
			{
				int NewQuest = guideQuestSystem.ChooseNewQuest();
		...
		{
			return Language.GetTextValue("Mods.Antiaris.GuideChat");
		}
		public class GuideQuestSystem : ModPlayer
		{
			...
			{
				Quests.Clear();
				Quests.Add(new Quest("Mods.Antiaris.GuideQuest", ModContent.ItemType<TheGuideforGuides>(), 1, 1d, "Mods.Antiaris.GuideThanks"));
			}
