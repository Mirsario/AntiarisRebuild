...
namespace Antiaris.NPCs.Town
{
	public class UnconsciousGuide : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "昏厥的向导");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Гид без сознания");
		}
		...
		public void WakeUp()
		{
			...
			npc.Transform(ModContent.NPCType<ConfusedGuide>());
		}
