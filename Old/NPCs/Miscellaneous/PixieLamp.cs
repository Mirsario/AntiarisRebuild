...
namespace Antiaris.NPCs.Miscellaneous
{
	public class PixieLamp : ModNPC
	{
		...
		public override void AI()
		{
			...
			Vector2 dustPos = new Vector2(npc.spriteDirection == -1 ? -6.0f : -3.0f, -20.0f).RotatedBy(npc.rotation, new Vector2());
			...
			npc.immune[255] = 30;
			for (int k = 0; k < 2; k++)
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 0.0f, 0.0f, ModContent.ProjectileType<PixieLampEffect>(), 0, 0.0f, 0, k, npc.whoAmI);
		...
		public override void OnChatButtonClicked(bool firstButton, ref bool shop)
		{
			if (firstButton)
			{
				...
				Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<PixieLamp>(), 1, false, 0, false, false);
			}
		}
	}
}
