		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.ai[0] == 0.0 && Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				for (int i = 0; i < numberProjectiles; i++)
				{
					...
					Projectile.NewProjectile(projectile.position.X, projectile.position.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<PurpleCrystalBullet>(), 0, 0.0f, projectile.owner, 1.0f, 0.0f);
				}
			}
		}
