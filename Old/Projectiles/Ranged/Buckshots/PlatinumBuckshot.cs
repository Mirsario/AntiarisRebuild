...
{
	public class PlatinumBuckshot : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "铂金火铳弹");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Платиновая картечь");
		}
		...
		{
			for (int k = 0; k < 8; k++)
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 84, projectile.oldVelocity.X * 0.2f, projectile.oldVelocity.Y * 0.2f);
