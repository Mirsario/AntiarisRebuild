...
{
	public class GoldBuckshot : ModProjectile
	{
		...
		{
			for (int k = 0; k < 8; k++)
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 10, projectile.oldVelocity.X * 0.2f, projectile.oldVelocity.Y * 0.2f);
