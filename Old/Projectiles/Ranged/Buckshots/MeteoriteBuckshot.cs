...
namespace Antiaris.Projectiles.Ranged.Buckshots
{
	public class MeteoriteBuckshot : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "陨铁铅弹");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Метеоритная картечь");
		}

		/*public void OverhaulInit()
		{
			this.SetTag(ProjectileTags.Bullet);
			this.SetTag(ProjectileTags.FixPenetration);
		}*/
