...
namespace Antiaris.Projectiles.Ranged
{
	public class CrystalEnergy : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "水晶能量");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Кристальная энергия");
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			NetMessage.SendData(MessageID.SpiritHeal, -1, -1, null, owner, healAmount, 0.0f, 0.0f, 0, 0, 0);
		}
