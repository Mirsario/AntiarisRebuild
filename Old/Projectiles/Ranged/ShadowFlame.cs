...
namespace Antiaris.Projectiles.Ranged
{
	public class ShadowFlame : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Теневой огонёк");
		}
		...
		public override void AI()
		{
			...
			{
				int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height / 2, 62);
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int num159 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 62, projectile.velocity.X * 0.1f, projectile.velocity.Y * 0.1f, 0, default, 0.3f);
			...
			if (Main.myPlayer == projectile.owner)
			{
				...
				for (int num161 = 0; num161 < num160; num161++)
				{
					...
					Projectile.NewProjectile(projectile.oldPosition.X + projectile.width / 2, projectile.oldPosition.Y + projectile.height / 2, value12.X, value12.Y, ProjectileID.MolotovFire, (int)(projectile.damage * 0.8), projectile.knockBack * 2.8f, projectile.owner, 0f, 0f);
				}
			}
		}
	}
