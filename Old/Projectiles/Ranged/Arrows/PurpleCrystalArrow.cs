	...
	public class PurpleCrystalArrow : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<PurpleCrystalArrow2>(), 0, 0.0f, projectile.owner, 0.0f, 0.0f);
			}
		}
