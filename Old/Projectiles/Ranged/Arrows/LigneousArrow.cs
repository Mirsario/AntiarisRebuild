...
namespace Antiaris.Projectiles.Ranged.Arrows
{
	public class LigneousArrow : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Древесная стрела");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				for (int num221 = 0; num221 < num220; num221++)
				{
					...
					Projectile.NewProjectile(projectile.position.X, projectile.position.Y, value17.X, value17.Y, ModContent.ProjectileType<LeafBush>(), projectile.damage / 3, 1f, projectile.owner, 0f, Main.rand.Next(-45, 1));
				}
			}
		}
