...
namespace Antiaris.Projectiles.Enemies
{
	public class WispFlame : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Огонь духа");
		...
		public override void AI()
		{
			...
			if (aiTimer < 240)
			{
				...
				{
					if (Main.npc[i].type == ModContent.NPCType<WilloWisp>() && projectile.ai[1] == Main.npc[i].whoAmI)
					{
