...
namespace Antiaris.Projectiles.Enemies
{
	public class LeafMagic : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "魔力树叶");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Лиственная магия");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Italian, "Foglia magica");
		}
