...
namespace Antiaris.Projectiles.Thrown
{
	public class MagmaBomb : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Магмовая бомба");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "熔岩炸弹");
		...
		public override void AI()
		{
			...
			if (!Main.npc[projTargetIndex].active)
				projectile.Kill();
