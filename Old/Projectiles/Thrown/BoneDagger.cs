...
namespace Antiaris.Projectiles.Thrown
{
	public class BoneDagger : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			int item = Main.rand.Next(2) == 0 ? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, ModContent.ItemType<BoneDagger>(), 1, false, 0, false, false) : 0;
