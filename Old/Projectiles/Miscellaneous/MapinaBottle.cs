...
namespace Antiaris.Projectiles.Miscellaneous
{
	public class MapinaBottle : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			Item.NewItem(projectile.position, ModContent.ItemType<DavysMap>(), 1, false, 0, false, false);
			Item.NewItem(projectile.position, ModContent.ItemType<Note2>(), 1, false, 0, false, false);
		}
	}
}
