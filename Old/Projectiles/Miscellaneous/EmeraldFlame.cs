...
{
	public class EmeraldFlame : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Emerald Flame");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Изумрудное пламя");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "翡翠火焰");
		...
		public override void AI()
		{
			...
			{
				player.AddBuff(ModContent.BuffType<EmeraldEssence>(), 300, true);
				projectile.Kill();
			}
			float ai2 = 0.5f;
