...
namespace Antiaris.Projectiles.Minions
{
	public class StardustEnergy : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "星尘能量");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Энергия звёздной пыли");
		}
