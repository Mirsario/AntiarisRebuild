...
namespace Antiaris.Projectiles.Minions
{
	public class Sand : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "沙子");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Песок");
		}
		...
		public override void AI()
		{
			...
			{
				int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 32, 0f, projectile.velocity.Y / 2f, 0, default, 1f);
