...
namespace Antiaris.Projectiles.Minions
{
	public class AntlionSummon : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "蚁狮蜂");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Взрослый муравьиный лев");
		}
		...
		public override void AI()
		{
			...
			float posX = player.Center.X - projCenter.X;
			float posY = player.Center.Y - projCenter.Y - 60f;
