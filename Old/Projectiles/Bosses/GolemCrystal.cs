...
{
	public class GolemCrystal : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "魔像水晶");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Кристалл голема");
		}
		...
		public override void AI()
		{
			...
			if (projectile.timeLeft == 540)
			{
				for (int k = 0; k < (double)count; k++)
				{
					...
					int dust_ = Dust.NewDust(projectile.Center - new Vector2(0.0f, 4.0f), 0, 0, 60, 0.0f, 0.0f, 0, new Color(), 1.0f);
