...
namespace Antiaris.Projectiles.Magic
{
	public class EnchantedDagger : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "附魔的光短剑");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Зачарованный клинок");
		}
