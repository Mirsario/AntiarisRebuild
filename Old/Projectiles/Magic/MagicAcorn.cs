...
namespace Antiaris.Projectiles.Magic
{
	public class MagicAcorn : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Жёлудь");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			int a = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, ModContent.ProjectileType<AcornCreature>(), projectile.damage, 1f, Main.myPlayer, 0f, 0f);
