...
namespace Antiaris.Projectiles.Magic
{
	public class SpearofDespair : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Копьё отчаяния");
		...
		public override void Kill(int timeLeft)
		{
			...
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, ModContent.ProjectileType<DespairBall>(), projectile.damage, 1f, projectile.owner, 0f, 0f);
			for (int i = 0; i < 5; i++)
			{
