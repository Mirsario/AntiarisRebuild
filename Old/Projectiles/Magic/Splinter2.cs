...
namespace Antiaris.Projectiles.Magic
{
	public class Splinter2 : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "尖刺");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Колючка");
		}
		...
		public override void AI()
		{
			...
			if (isStickingToTarget)
			{
				...
				if (projectile.localAI[0] >= 60 * aiFactor// If it's time for this javelin to die, kill it
