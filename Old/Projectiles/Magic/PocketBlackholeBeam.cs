...
namespace Antiaris.Projectiles.Magic
{
	public class PocketBlackholeBeam : ModProjectile
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Vector2 vector2_2 = new Vector2(projectile.width, projectile.height) / 2f + Vector2.UnitY * projectile.gfxOffY - Main.screenPosition;
			...
			DelegateMethods.c_1 = new Color(253, 108, 227, sbyte.MaxValue) * 0.75f * projectile.Opacity;
