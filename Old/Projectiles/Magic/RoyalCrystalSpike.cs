...
namespace Antiaris.Projectiles.Magic
{
	public class RoyalCrystalSpike : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Шип королевского кристала");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "皇家水晶尖刺");
