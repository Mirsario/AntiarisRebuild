...
namespace Antiaris.Projectiles.Melee.Flails
{
	public class TheBuccaneersBuster : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "海盗的掠夺");
		}
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			{
				int shrapnel = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, ModContent.ProjectileType<BigBone>(), 0, 1f, projectile.owner, 0f, Main.rand.Next(-45, 1));
