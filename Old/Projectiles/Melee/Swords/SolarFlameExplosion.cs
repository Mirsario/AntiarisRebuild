...
namespace Antiaris.Projectiles.Melee.Swords
{
	public class SolarFlameExplosion : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "日曜炙焰爆炸");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Взрыв солнечной вспышки");
		}
