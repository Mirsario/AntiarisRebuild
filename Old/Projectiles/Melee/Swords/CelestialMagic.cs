...
namespace Antiaris.Projectiles.Melee.Swords
{
	public class CelestialMagic : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int dust = Dust.NewDust(new Vector2(projectile.position.X + 3f, projectile.position.Y + 3f) - projectile.velocity * 0.5f, projectile.width - 8, projectile.height - 8, 73, 0.0f, 0.0f, 100, new Color(), 1f);
