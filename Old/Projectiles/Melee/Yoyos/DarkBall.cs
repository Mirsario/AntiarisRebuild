...
namespace Antiaris.Projectiles.Melee.Yoyos
{
	class DarkBall : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "暗影球");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Темный шар");
		}
		...
		public override void AI()
		{
			...
			for (int k = 0; k < 1; k++)
			{
				int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 62, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, Color.White, 1.5f);
