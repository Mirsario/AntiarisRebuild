			...
			if (hits == 5)
			{
				if (projectile.owner == Main.myPlayer)
				{
					...
					for (int num221 = 0; num221 < num220; num221++)
					{
						...
						value17.Normalize();
						value17 *= 100 * 0.06f;
						int honey = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, value17.X, value17.Y, ModContent.ProjectileType<HoneySpray>(), projectile.damage / 2, 1f, Main.myPlayer, 0f);
						Main.projectile[honey].penetrate = 5;
					}
				}
			}
		}
