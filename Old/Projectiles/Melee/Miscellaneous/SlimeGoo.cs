...
namespace Antiaris.Projectiles.Melee.Miscellaneous
{
	public class SlimeGoo : ModProjectile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "绿色凝胶球");
		}
		...
		public override void AI()
		{
			for (int k = 0; k < 5; k++)
			{
				int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 61, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, Color.White, 1.5f);
