...
namespace Antiaris.Projectiles.Melee.Spears
{
	public class TerraSpearPro : ModProjectile
	{
		public override Color? GetAlpha(Color lightColor)
		{
			...
			int color = (int)((projectile.localAI[1] - 5.0) / 10.0 * 255);
		...
		{
			++projectile.ai[1];
			if (projectile.ai[1] % 10.0 == 0.0)
				Projectile.NewProjectile(projectile.position, Vector2.Zero, ModContent.ProjectileType<TerraSpearOrb>(), projectile.damage, (int)(projectile.knockBack * 0.7f), projectile.owner);
		}
