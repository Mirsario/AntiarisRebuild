...
namespace Antiaris.Projectiles.Melee.Spears
{
	public class GooSpear : ModProjectile
	{
		public override void SetDefaults()
		{
			...
			projectile.alpha = 0;
			projectile.glowMask = AntiarisGlowMasks.GooSpearP;
		}
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Копье из слищи");
		}
		...
		public override void AI()
		{
			...
			if (player.itemAnimation < player.itemAnimationMax / 3)
			{
				...
				if (projectile.localAI[0] == 0f)
				{
					...
					{
						Projectile.NewProjectile(projectile.Center.X + projectile.velocity.X, projectile.Center.Y + projectile.velocity.Y, projectile.velocity.X * 2f, projectile.velocity.Y * 2, ModContent.ProjectileType<SlimeGoo>(), projectile.damage, projectile.knockBack * 0.85f, projectile.owner, 0f, 0f);
					}
				}
			}
		}
