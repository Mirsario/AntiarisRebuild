...
{
	public class GoldBoomerangSpark : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Gold Spark");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "金色火花");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Золотая искра");
		}
		...
		public override void AI()
		{
			...
			if (projectile.localAI[0] > 3f)
			{
				...
				{
					int num92 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height, 60, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, default, 2f);
