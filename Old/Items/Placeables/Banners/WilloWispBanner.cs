...
namespace Antiaris.Items.Placeables.Banners
{
	public class WilloWispBanner : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Знамя блуждающего огонька");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Игроки поблизости получают бонус против: Блуждающий огонёк");
		}
	}
}
