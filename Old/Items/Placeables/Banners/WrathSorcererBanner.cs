...
namespace Antiaris.Items.Placeables.Banners
{
	public class WrathSorcererBanner : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Знамя яростного колдуна");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Игроки поблизости получают бонус против: Яростный колдун");
		}
	}
}
