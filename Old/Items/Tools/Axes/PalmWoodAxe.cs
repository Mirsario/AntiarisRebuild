...
namespace Antiaris.Items.Tools.Axes
{
	public class PalmWoodAxe : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "棕榈木斧");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Топор из пальмовой древесины");
		}
