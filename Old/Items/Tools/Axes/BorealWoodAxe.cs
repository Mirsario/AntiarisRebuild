...
namespace Antiaris.Items.Tools.Axes
{
	public class BorealWoodAxe : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "针叶木斧");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Топор из северной древесины");
		}
