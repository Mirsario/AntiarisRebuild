...
namespace Antiaris.Items.Tools.Axes
{
	public class PearlwoodAxe : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "珍珠木斧");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Топор из жемчужной древесины");
		}
