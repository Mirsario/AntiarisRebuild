...
namespace Antiaris.Items.Tools
{
	public class EmeraldNet : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "翡绿捕虫网");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "当装备皇家凝胶时可以捕获史莱姆和获取绿色凝胶");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Изумрудный сачок");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Позволяет ловить слизней и получать зеленую слизь");
		}
