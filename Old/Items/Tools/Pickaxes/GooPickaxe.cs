...
namespace Antiaris.Items.Tools.Pickaxes
{
	public class GooPickaxe : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "凝胶镐");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Кирка из слизи");
		}
		...
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddRecipeGroup("Antiaris:WoodenPickaxe")
				.AddTile(16)
				.Register();
		}
	}
