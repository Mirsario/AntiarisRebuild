...
namespace Antiaris.Items.Quests
{
	public class MagicalAmulet : QuestItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "神奇的护身符");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "这个奇怪的护身符是船长的\n可以使持有者不朽");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Магический амулет");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "'Этот странный амулет принадлежит Пирату'\nДает неуявзимость носителю");
		}
		...
		{
			CreateRecipe()
				.AddIngredient(null, "AmuletPiece1", 1)
				.AddIngredient(null, "AmuletPiece2", 1)
				.AddIngredient(null, "AmuletPiece3", 1)
				.Register();
		}
	}
}
