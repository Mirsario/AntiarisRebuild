...
namespace Antiaris.Items.Quests
{
	public class AdventurersFishingRodPart2 : QuestItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "冒险家鱼竿的部件");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Часть удочки Путешественника");
		}
	}
}
