...
namespace Antiaris.Items.Miscellaneous
{
	public class HeavenlyClock : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "天国之钟");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、显示时间\n2、使用后加快时间流逝速度\n[C/FF0220:加速可能会导致无法挽回的后果]\n“天国的造物”");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Райские часы");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Показывают время\nУскоряют время при использовании\n[c/FF0220:Ускорение может вызвать необратимые последствия]\n'Сковано на небесах'");
		}
