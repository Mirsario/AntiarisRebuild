...
namespace Antiaris.Items.Weapons.Summoning
{
	public class AntlionStave : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Посох муравьиного льва");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "蚁狮法杖");
			Tooltip.SetDefault("Summons an antlion that rapidly spits out a burst of sand");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "召唤一个能够迅速发射沙子的蚁狮");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Призывает муравьиного льва, который часто выплёвывает песок");
		}
