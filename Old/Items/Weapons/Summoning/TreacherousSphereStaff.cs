...
namespace Antiaris.Items.Weapons.Summoning
{
	public class TreacherousSphereStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<TrueTreacherousSphere>();
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Посох коварной сферы");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "千瞬光球法杖");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、召唤一个千瞬光球\n2、光球会对你的敌人发射闪电");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Призывает коварную сферу\nСфера стреляет энергетическими снарядами в ваших противников");
		}
