...
namespace Antiaris.Items.Weapons.Melee.Swords
{
	public class VoidFlare : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<TrueCelestialMagicCentral>();
			item.shootSpeed = 22f;
		}
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Огонь бездны");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "至黑之日");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "在光标周围召唤一圈神圣火焰\n“晃眼的光，表象，毫无意识的强合力”");
			Tooltip.SetDefault("Summons a circle of celestial flames around the cursor");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Призывает кольцо из небесного пламени вокруг курсора");
		}
