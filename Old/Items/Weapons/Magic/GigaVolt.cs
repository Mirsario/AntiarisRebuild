	...
	public class GigaVolt : ModItem
	{
		...
		public override bool CanUseItem(Player player)
		{
			...
			else if (player.altFunctionUse != 2)
			{
				...
				{
					item.damage = 30;
					item.shoot = ModContent.ProjectileType<SmallElectricCharge>();
					item.shootSpeed = 8f;
				...
				if (aPlayer.VoltCharge == 1)
				{
					...
					item.shoot = ModContent.ProjectileType<ElectricCharge>();
					item.shootSpeed = 8f;
				...
				if (aPlayer.VoltCharge == 4)
				{
					...
					item.channel = true;
					aPlayer.VoltCharge = 0;
					item.shoot = ModContent.ProjectileType<Lightning1>();
					item.shootSpeed = 4f;
					item.autoReuse = true;
					item.useAnimation = 15;
					item.useTime = 15;
