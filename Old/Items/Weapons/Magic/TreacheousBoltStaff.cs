...
namespace Antiaris.Items.Weapons.Magic
{
	public class TreacheousBoltStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<TrueEnergy>();
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "千瞬闪电杖");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Посох коварной молнии");
		}
