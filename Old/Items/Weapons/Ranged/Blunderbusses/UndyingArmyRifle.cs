...
namespace Antiaris.Items.Weapons.Ranged.Blunderbusses
{
	public class UndyingArmyRifle : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "不朽来福枪");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "使用火铳弹当做弹药\n发射二连发子弹\n每次只消耗一颗子弹");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Винтовка бессмертной армии");
