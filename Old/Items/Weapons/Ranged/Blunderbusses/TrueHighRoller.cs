...
namespace Antiaris.Items.Weapons.Ranged.Blunderbusses
{
	public class TrueHighRoller : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "真·暴殄天物");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、使用火铳弹作为弹药\n2、发射略微分散的两个火铳弹\n3、火铳弹将附加绝望烈焰\n4、有概率发射出觉醒之弹，增加远程武器的伤害");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Истинный Крупный игрок");
		...
		{
			CreateRecipe()
				.AddIngredient(null, "HighRoller", 1)
