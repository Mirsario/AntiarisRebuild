...
namespace Antiaris.Items.Weapons.Ranged.Blunderbusses
{
	public class HighRoller : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "暴殄天物");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、使用火铳弹作为弹药\n2、发射略微分散的两个火铳弹\n3、火铳弹将附加绝望烈焰\n“It feels flat and very hot, but you can't argue with results”");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Крупный игрок");
		...
		{
			CreateRecipe()
				.AddIngredient(null, "DevilDragon", 1)
				.AddIngredient(null, "UndyingArmyRifle", 1)
				.AddIngredient(null, "CherryBlossom", 1)
				.AddIngredient(null, "BoilingPoint", 1)
				.AddTile(26)
				.Register();

			recipe = new ModRecipe(mod);
				.AddIngredient(null, "CrimsonDrake", 1)
				.AddIngredient(null, "UndyingArmyRifle", 1)
				.AddIngredient(null, "CherryBlossom", 1)
				.AddIngredient(null, "BoilingPoint", 1)
				.AddTile(26)
