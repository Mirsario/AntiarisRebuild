...
{
	public class IchorFlamethrower : ModItem
	{
		...
		{
			DisplayName.SetDefault("Ichor Flamethrower");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "脓血喷火器");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Ихоровый огнемёт");
		}
