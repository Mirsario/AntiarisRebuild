...
namespace Antiaris.Items.Equipables.Accessories
{
	...
	public class CrimtaneLeechRing : ModItem
	{
		...
		{
			DisplayName.SetDefault("Crimtane Leech Ring");
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "血蛭血戒");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、在玩家周围召唤一个魔法圈\n2、在魔法圈内击杀敌人可以恢复 5% 的体力\n3、减少 10% 最大体力值");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Кримтановое кольцо кровососа");
