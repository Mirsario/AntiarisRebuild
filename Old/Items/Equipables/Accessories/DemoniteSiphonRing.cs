...
namespace Antiaris.Items.Equipables.Accessories
{
	...
	public class DemoniteSiphonRing : ModItem
	{
		...
		{
			DisplayName.SetDefault("Demonite Siphon Ring");
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "虹吸魔戒");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、在玩家周围召唤一个魔法圈\n2、在魔法圈内击杀敌人可以恢复 15% 的魔力\n3、减少 10% 最大魔力值");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Демонитовое кольцо сифона");
