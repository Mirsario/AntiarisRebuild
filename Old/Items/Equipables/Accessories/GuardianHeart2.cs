	...
	public class GuardianHeart2 : ModItem
	{
		...
		public override void UpdateAccessory(Player player, bool hideVisual)
		{
			...
			if (timer >= 480.0)
			{
				...
				player.AddBuff(ModContent.BuffType<Amplification2>(), 600, true);
				player.AddBuff(ModContent.BuffType<BloodRepletion2>(), Main.rand.Next(4400, 5200), true);
			}
		}
		...
		{
			CreateRecipe()
				.AddIngredient(null, "ShadowChargedCrystal", 17)
