...
namespace Antiaris.Items.Equipables.Armor.Developers
{
	...
	public class NokilosAngelicChestplate : ModItem
	{
		...
		{
			DisplayName.SetDefault("Nokilos' Angelic Chestplate");
			Tooltip.SetDefault("'Great for impersonating devs!'");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Ангельский нагрудник Nokilos");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "'Поможет вам выдать себя за разработчика!'");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "Nokilos护胸");
