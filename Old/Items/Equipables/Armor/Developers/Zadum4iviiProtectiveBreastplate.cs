...
namespace Antiaris.Items.Equipables.Armor.Developers
{
	...
	public class Zadum4iviiProtectiveBreastplate : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Защитный нагрудник Zadum4ivii");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "'Поможет вам выдать себя за разработчика!'");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "Zadum4ivii的护身胸甲");
