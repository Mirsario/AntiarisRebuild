...
namespace Antiaris.Items.Equipables.Armor.Mixed
{
	...
	public class GooHelmet : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "自身移动时所有类型伤害增加 5%");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Шлем из слизи");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Увеличивает весь урон на 5%, если игрок двигается");
		}
		...
		{
			return body.type == ModContent.ItemType<GooBreastplate>() && legs.type == ModContent.ItemType<GooGreaves>();
		}
		...
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddRecipeGroup("Antiaris:WoodHelmet")
				.AddTile(16)
				.Register();
		}
	}
