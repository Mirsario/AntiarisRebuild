...
{
	public class RedCrystalPixieDust : ModItem
	{
		...
		{
			DisplayName.SetDefault("Red Crystal Pixie Dust");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Красная кристальная пыльца пикси");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "红水晶精灵尘");
		}
	}
}
