...
{
	public class TowerKeeperTreasureBag2 : ModItem
	{
		...
		public override int BossBagNPC => ModContent.NPCType<TowerKeeper2>();
		...
		public override void OpenBossBag(Player player)
		{
			...
			player.QuickSpawnItem(ModContent.ItemType<ShadowChargedCrystal>(), Main.rand.Next(15, 24));
			...
			if (Main.rand.Next(7) == 0)
			{
				player.QuickSpawnItem(ModContent.ItemType<GuardianHeart2>());
			}
		}
	}
}