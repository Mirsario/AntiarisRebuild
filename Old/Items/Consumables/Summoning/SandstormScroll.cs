...
namespace Antiaris.Items.Consumables.Summoning
{
	public class SandstormScroll : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Свиток песчаной бури");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Начинает песчаную бурю");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "沙暴卷轴");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "召唤沙暴");
		}
