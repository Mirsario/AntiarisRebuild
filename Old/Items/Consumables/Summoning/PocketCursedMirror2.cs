...
namespace Antiaris.Items.Consumables.Summoning
{
	public class PocketCursedMirror2 : ModItem
	{
		...
		{
			return Main.hardMode && player.ZoneCrimson && !NPC.AnyNPCs(ModContent.NPCType<TowerKeeperNonActive>()) && !NPC.AnyNPCs(ModContent.NPCType<TowerKeeper>()) && !NPC.AnyNPCs(ModContent.NPCType<TowerKeeper2>());
		}
		...
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddIngredient(null, "BloodyChargedCrystal", 3)
		...
		public override bool UseItem(Player player)
		{
			...
			{
				NPC.SpawnOnPlayer(player.whoAmI, ModContent.NPCType<TowerKeeper>());
			}
			return true;
		}
	}
