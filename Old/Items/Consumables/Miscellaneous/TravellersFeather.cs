...
namespace Antiaris.Items.Consumables.Miscellaneous
{
	public class TravellersFeather : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Перо путешественника");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Russian, "Изменяет задание Путешественника");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "漂泊者之羽");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "改变冒险家的任务");
		}
