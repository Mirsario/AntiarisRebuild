...
namespace Antiaris.Items.Consumables.Potions
{
	public class TropicalLeafRoll : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.buffType = ModContent.BuffType<NatureShield>();
			item.buffTime = 3600;
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "热带叶卷");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、10 秒内每秒可以恢复 1 点体力\n2、能够使用 5 次\n3、对一些Debuff提供免疫");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Рулон тропических листьев");
		...
		{
			CreateRecipe()
				.AddIngredient(null, "TropicalLeaf", 10)
