...
namespace Antiaris.Items.Consumables.Potions
{
	public class PalmLeafRoll : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "棕榈叶叶卷");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、10 秒内每秒可以恢复 1 点体力\n2、能够使用 10 次");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Рулон пальмовых листьев");
		...
		{
			CreateRecipe()
				.AddIngredient(null, "PalmLeaf", 10)
