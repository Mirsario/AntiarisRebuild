...
{
	public class OrganLeafRoll : ModItem
	{
		byte Uses = 5;
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "腐化叶卷");
			Tooltip.AddTranslation((int)GameCulture.CultureName.Chinese, "1、10 秒内每秒可以恢复 1 点体力\n2、能够使用 5 次\n3、增加生命恢复速度");
			DisplayName.AddTranslation((int)GameCulture.CultureName.Russian, "Рулон листьев из органов");
		...
		{
			CreateRecipe()
				.AddIngredient(null, "OrganLeaf", 10)
