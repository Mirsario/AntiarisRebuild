...
namespace Antiaris.Tiles.MusicBoxes
{
	class AntlionQueenMusicBox : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<AntlionQueenMusicBox>(), 1, false, 0, false, false);
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.showItemIcon2 = ModContent.ItemType<AntlionQueenMusicBox>();
		}
	}
}
