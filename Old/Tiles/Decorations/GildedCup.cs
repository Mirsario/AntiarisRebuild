...
namespace Antiaris.Tiles.Decorations
{
	public class GildedCup : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "镀金杯");
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Позолоченная чаша");
			AddMapEntry(new Color(246, 214, 126), name);
		}

		public override bool Drop(int i, int j)
		{
			Item.NewItem(i * 16, j * 16, 32, 16, ModContent.ItemType<GildedCup>(), 1, false, 0, false, false);
			return false;
		}
	}
}
