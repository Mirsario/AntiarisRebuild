...
{
	public class ShadewoodCabinet : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Шкаф из теневой древесины");
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "暗影木柜橱");
			AddMapEntry(new Color(191, 142, 111), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Containers };
			chest = ("Shadewood Cabinet");
			chestDrop = ModContent.ItemType<ShadewoodCabinet>();
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				player.showItemIcon2 = ModContent.ItemType<ShadewoodCabinet>();
			}
			player.noThrow = 2;
