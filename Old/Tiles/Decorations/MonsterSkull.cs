...
{
	public class MonsterSkull : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Monster Skull");
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Череп монстра");
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "古生物骸骨");
			AddMapEntry(new Color(160, 142, 106), name);
