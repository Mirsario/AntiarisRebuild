...
namespace Antiaris.Tiles.Decorations
{
	public class QuillPenStand : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "羽毛笔笔座");
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Перо на подставке");
			AddMapEntry(new Color(79, 62, 51), name);
		}

		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(i * 16, j * 16, 16, 16, ModContent.ItemType<QuillPenStand>(), 1, false, 0, false, false);
		}
	}
}
