...
namespace Antiaris.Tiles.Miscellaneous
{
	public class DazzlingHeart : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Сияющее сердце");
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "璀璨之心");
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 48, ModContent.ItemType<DazzlingHeart>(), 1, false, 0, false, false);
		}
