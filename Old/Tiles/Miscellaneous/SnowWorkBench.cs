...
namespace Antiaris.Tiles.Miscellaneous
{
	public class SnowWorkBench : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "工作台");
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Верстак");
		...
		/*public void OverhaulInit()
		{
			...
			this.SetTag(TileTags.ColdBiomeRelated);
		}*/
