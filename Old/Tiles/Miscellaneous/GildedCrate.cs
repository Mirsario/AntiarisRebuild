...
namespace Antiaris.Tiles.Miscellaneous
{
	public class GildedCrate : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "镀金板条箱");
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Позолоченный ящик");
		...
		{
			Item.NewItem(i * 16, j * 16, 32, 16, ModContent.ItemType<GildedCrate>(), 1, false, 0, false, false);
		}
	}
}
