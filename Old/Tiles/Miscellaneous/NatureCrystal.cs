...
namespace Antiaris.Tiles.Miscellaneous
{
	public class NatureCrystal : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Кристалл природы");
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "自然精华");
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 48, ModContent.ItemType<NatureEssence>(), Main.rand.Next(2, 4), false, 0, false, false);
		}
