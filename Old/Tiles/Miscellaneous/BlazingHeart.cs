...
namespace Antiaris.Tiles.Miscellaneous
{
	public class BlazingHeart : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.AddTranslation((int)GameCulture.CultureName.Russian, "Пылающее сердце");
			name.AddTranslation((int)GameCulture.CultureName.Chinese, "燃烧之心");
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 48, ModContent.ItemType<BlazingHeart>(), 1, false, 0, false, false);
		}
