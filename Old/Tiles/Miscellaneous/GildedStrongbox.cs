	...
	public class GildedStrongbox : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			if (Main.rand.Next(20) == 0)
				Item.NewItem(i * 16, j * 16, 32, 16, ModContent.ItemType<GiantEmerald>(), 1, false, 0, false, false);
			if (Main.rand.Next(20) == 0)
				Item.NewItem(i * 16, j * 16, 32, 16, ModContent.ItemType<GiantDiamond>(), 1, false, 0, false, false);
