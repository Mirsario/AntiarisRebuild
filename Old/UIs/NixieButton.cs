...
namespace Antiaris.UIs
{
	public class NixieButton : UIElement
	{
		...
		public override void Click(UIMouseEvent evt)
		{
			...
			{
				SoundEngine.PlaySound(28, (int)Main.LocalPlayer.position.X, (int)Main.LocalPlayer.position.Y, 0);
				...
				for (int i = x; i < x + width; i++)
				{
					for (int j = y; j < y + height; j++)
					{
						...
						if (tile.active())
						{
							...
							int index = Index - 35;
							tile.frameX = (short)(tile.frameX % frameWidth);
							tile.frameY = (short)(tile.frameY % frameHeight);
	...
	public class UIDisable : UIElement
	{
		...
		public override void Click(UIMouseEvent evt)
		{
			if (NixieTubeUI.visible)
			{
				SoundEngine.PlaySound(11, (int)Main.LocalPlayer.position.X, (int)Main.LocalPlayer.position.Y, 0);
