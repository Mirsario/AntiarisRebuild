...
namespace Antiaris.UIs
{
	...
	public class NixieTubeUI : UIState
	{
		...
		public override void OnInitialize()
		{
			...
			MainPanel.Height.Set(Language.ActiveCulture == (int)GameCulture.CultureName.Russian ? 370 : 220, 0);
			...
			int xPos = 0;
			int yPos = 0;
			for (int i = 0; i < (Language.ActiveCulture == (int)GameCulture.CultureName.Russian ? 73 : 41); i++)
			{
			...
			button2.Top.Set(Language.ActiveCulture == (int)GameCulture.CultureName.Russian ? 330 : 180, 0);
