...
namespace Antiaris.UIs
{
	class QuestTrackerUI : UIState
	{
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			if (AntiarisMod.trackerTexture != null)
				spriteBatch.Draw(AntiarisMod.trackerTexture, new Vector2(QuestTrackerPanel.Left.Pixels, QuestTrackerPanel.Top.Pixels), Color.White);
		}
		...
		{
			SoundEngine.PlaySound(12, (int)Main.LocalPlayer.position.X, (int)Main.LocalPlayer.position.Y, 0);
